...
%% \label inside equation not working due to
%% https://gitlab.com/perm.pub/baseprinter/-/issues/9
\end{equation}
...
\begin{figure}[tb]
	\centering
	\includegraphics[width = 0.75 \textwidth]{figures/source-header.png}
...
\begin{figure}[t]
	\centering
	\includegraphics[width = 0.75 \textwidth]{figures/windows-311.png}
...
{
	\fboxsep=0pt
	\mbox{\includegraphics[width = 0.325 \textwidth]{figures/iv-single-alpharf0.png}}
	\hfill
	\mbox{\includegraphics[width = 0.325 \textwidth]{figures/iv-single-alpharf1.png}}
	\hfill
	\mbox{\includegraphics[width = 0.325 \textwidth]{figures/iv-single-alpharf2.png}}
}
...
{
	\fboxsep=0pt
	\mbox{\includegraphics[width = 0.325 \textwidth]{figures/iv-pulsed-alpharf0.png}}
	\hfill
	\mbox{\includegraphics[width = 0.325 \textwidth]{figures/iv-pulsed-alpharf5.png}}
	\hfill
	\mbox{\includegraphics[width = 0.325 \textwidth]{figures/iv-pulsed-alpharf10.png}}
}
...
\begin{figure}[t]
	\centering
	\includegraphics[width = 0.7 \textwidth]{figures/PULS0050-IV.pdf}
...
\begin{figure}[!p]
	\centering
	\includegraphics[width = 0.45 \textwidth]{figures/SINGLE2.pdf}
	\includegraphics[width = 0.45 \textwidth]{figures/PULS0250.pdf}
	\includegraphics[width = 0.45 \textwidth]{figures/PULS0125.pdf}
	\includegraphics[width = 0.45 \textwidth]{figures/PULS0050.pdf}
...
\begin{figure}[t]
	\centering
	\includegraphics[width = 0.45 \textwidth]{figures/SINGLE-BETA1.pdf}
	\includegraphics[width = 0.45 \textwidth]{figures/PULS0050-BETA1.pdf}
