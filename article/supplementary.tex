...
\begin{figure}[h]
    \centering
    \includegraphics[width = \textwidth]{meld-comparison.png}
...
\begin{figure}[p]
    \centering
    \includegraphics[width = \textwidth]{batch-file.png}
...
\lstset{
    ...
    morekeywords = {DEFINE, defined, if, endif},
    alsoother = {$, \#},
    deletekeywords = {for}
}
%===============================================================================
...
\begin{figure}[p]
    \centering
    \includegraphics[width = \textwidth]{stepampl.png}
...
\begin{figure}[p]
	\centering
	\includegraphics[width = \textwidth]{vb-project.png}
